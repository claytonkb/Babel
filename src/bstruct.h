...
void  *_newlfi(bvm_cache *this_bvm, mword size, mword init);
mword *_newlfcp(bvm_cache *this_bvm, const mword *array, mword size);
void  *_mklf(bvm_cache *this_bvm, mword array_size, ...);
void  *_val(bvm_cache *this_bvm, mword value);
void  *_newin(bvm_cache *this_bvm, mword size);
...
void  *_ptr(bvm_cache *this_bvm, mword *unsafe_ptr);
...
mword *bstruct_load_template(bvm_cache *this_bvm, mword *template_bs, mword *rel_offsets, mword *abs_offsets);
