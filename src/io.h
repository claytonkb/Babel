...
void _stdoutop8(bvm_cache *this_bvm, mword *string);
...
void _spit(bvm_cache *this_bvm, char *filename, mword *fileout);
bvm_cache *journal(bvm_cache *this_bvm);
void _journal(bvm_cache *this_bvm, char *filename, mword *fileout);
bvm_cache *spit_mword(bvm_cache *this_bvm);
bvm_cache *stdoutop(bvm_cache *this_bvm);
bvm_cache *stdinln(bvm_cache *this_bvm);
void _spit_mword(bvm_cache *this_bvm, char *filename, mword *fileout);
...
//void spit(void);
//void _spit(this_bvm, char *filename, mword *fileout);
//void journal(void);
//void _journal(this_bvm, char *filename, mword *fileout);
//void stdoutop(void);
//void stdoutop8(void);
//void stdinln(void);
